...
<body>
	...
	<div class="container">
		...
		%>
		<form
			action="/approval/appdetailddraft?app_no=${approval.app_no}&app_kind=${approval.app_kind}"
			method="post">
			...
			<center>
				<a
					href="/approval/appupdatedraftform?app_no=${approval.app_no}&app_kind=${approval.app_kind}">수정</a>
				&emsp;&emsp;&emsp;&emsp;&emsp; <a
					href="/approval/appdeletedraft?app_no=${approval.app_no}">삭제</a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
